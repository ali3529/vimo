...
function EditPhoneNumber(props) {
    ...
    const mutateOtp = useMutation(["getOtp"], (phone) => getOtp(phone), {
        onSuccess: (res) => {
            if (res?.data?.done) {
                navigate("/profile/edit-verify-code", {
                    replace: true,
        ...
        <div className="w-full h-full flex flex-col">
            ...
            <div className="h-full  md:pt-[86px] md:overflow-scroll w-full bg-black-BG">
                <div className="flex max-w-[640px] mx-auto flex-col justify-center  items-center pt-[48px]">
                    <div dir="rtl" className="pt-[38px]">
                    <ToolBar ContainerStyle={"!backdrop-blur-none"} style={"!backdrop-blur-none"}  chevronColor="#ffffff" title="ویرایش شماره"/>
                    </div>
                    <div className="flex flex-col   -mt-[130px] z-10 w-full justify-center items-center">
                        <p className="text-gray-A text-[1.6rem] mt-6 z-10 fa-format-500">
